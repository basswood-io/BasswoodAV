...
from bv.sidedata.motionvectors import MotionVectors
...
cdef class SideData(Buffer):
    ...
    def __repr__(self):
        return f"<bv.sidedata.{self.__class__.__name__} {self.ptr.size} bytes of {self.type} at 0x{<unsigned int>self.ptr.data:0x}>"
