...
from bv.codec.hwaccel cimport wrap_hwconfig
from bv.descriptor cimport wrap_avclass
...
cdef class Codec:
    ...
    def __repr__(self):
        mode = self.mode
        return f"<bv.{self.__class__.__name__} {self.name} {mode=}>"
    ...
    def capabilities(self):
        ...
        .. code-block:: python
            ...
            from bv.codec import Codec, Capabilities
